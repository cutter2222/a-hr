...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF06AEEF);
  late Color secondary = const Color(0xFF283F94);
  late Color tertiary = const Color(0xFF015CAC);
  late Color alternate = const Color(0xFFA6A7A9);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF616161);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F6F9);
  late Color accent1 = const Color(0xFF6BCEF6);
  late Color accent2 = const Color(0xFF1F2024);
  late Color accent3 = const Color(0xFF131313);
  late Color accent4 = const Color(0xFF868D94);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF0000);
  late Color info = const Color(0xFF8F9098);

  late Color primaryBtnText = const Color(0xFFFFFFFF);
  late Color lineColor = const Color(0xFFE0E3E7);
  late Color white70 = const Color(0xB3FFFFFF);
  late Color primary600 = const Color(0xFFCB0A41);
  late Color inputFieldBorder = const Color(0x33868D94);
}
