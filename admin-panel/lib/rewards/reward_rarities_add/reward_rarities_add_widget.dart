...
class _RewardRaritiesAddWidgetState extends State<RewardRaritiesAddWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.rewardRaritiesRow != null) {
        safeSetState(() {
          _model.nameInputTextController?.text =
              widget.rewardRaritiesRow!.name!;
        });
        safeSetState(() {
          _model.descriptionInputTextController?.text =
              widget.rewardRaritiesRow!.info!;
        });
      } else {
        return;
      }
                                                ...
                                                onPressed: () async {
                                                  await RewardRaritiesTable()
                                                    ...
                                                    matchingRows: (rows) =>
                                                        rows.eqOrNull(
                                                      'id',
                                                      widget.rewardRaritiesRow
                                                          ?.id,
                                                    ),
                                                  );

                                                  context.pushNamed(
                                                    RewardRaritiesWidget
                                                        .routeName,
