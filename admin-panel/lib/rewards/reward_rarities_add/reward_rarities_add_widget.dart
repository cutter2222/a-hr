...
import 'reward_rarities_add_model.dart';
export 'reward_rarities_add_model.dart';

class RewardRaritiesAddWidget extends StatefulWidget {
  const RewardRaritiesAddWidget({
    super.key,
    this.rewardRaritiesRow,
  });

  final RewardRaritiesRow? rewardRaritiesRow;

  static String routeName = 'RewardRaritiesAdd';
  static String routePath = 'RewardRaritiesAdd';

  @override
  State<RewardRaritiesAddWidget> createState() =>
      _RewardRaritiesAddWidgetState();
}

class _RewardRaritiesAddWidgetState extends State<RewardRaritiesAddWidget> {
  late RewardRaritiesAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RewardRaritiesAddModel());
                                    ...
                                    children: [
                                      wrapWithModel(
                                        ...
                                        updateCallback: () =>
                                            safeSetState(() {}),
                                        child: AppBarWidget(
                                          title: 'уровень редкости',
                                          isTitle:
                                              widget.rewardRaritiesRow != null,
                                        ),
                                      ),
                                      Expanded(
                                        child: Padding(
