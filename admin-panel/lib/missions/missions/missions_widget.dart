...
export 'missions_model.dart';

class MissionsWidget extends StatefulWidget {
  const MissionsWidget({super.key});

  static String routeName = 'Missions';
  static String routePath = 'missions';
...
class _MissionsWidgetState extends State<MissionsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MissionsModel());
