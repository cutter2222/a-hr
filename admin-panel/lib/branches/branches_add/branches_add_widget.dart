...
import 'branches_add_model.dart';
export 'branches_add_model.dart';

class BranchesAddWidget extends StatefulWidget {
  const BranchesAddWidget({
    super.key,
    this.branchesRow,
  });

  final BranchesRow? branchesRow;

  static String routeName = 'BranchesAdd';
  static String routePath = 'branchesAdd';

  @override
  State<BranchesAddWidget> createState() => _BranchesAddWidgetState();
}

class _BranchesAddWidgetState extends State<BranchesAddWidget> {
  late BranchesAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BranchesAddModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.branchesRow != null) {
        safeSetState(() {
          _model.nameInputTextController?.text = widget.branchesRow!.name!;
        });
        safeSetState(() {
          _model.descriptionInputTextController?.text =
              widget.branchesRow!.description!;
        });
        safeSetState(() {
          _model.orderInputTextController?.text =
              widget.branchesRow!.orderIndex!.toString();
        });
        safeSetState(() {
          _model.roleInputValueController?.value = widget.branchesRow!.role!;
        });
        safeSetState(() {
          _model.statusInputValueController?.value =
              widget.branchesRow!.isActive!.toString();
        });
      } else {
        return;
      }
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      wrapWithModel(
                                        ...
                                        child: AppBarWidget(
                                          title: 'ветку',
                                          isTitle: widget.branchesRow != null,
                                        ),
                                      ),
                                      Expanded(
                                        child: Padding(
                                                  ...
                                                  if ((_model
                                                    ...
                                                    await BranchesTable()
                                                      ...
                                                      matchingRows: (rows) =>
                                                          rows.eqOrNull(
                                                        'id',
                                                        widget.branchesRow?.id,
                                                      ),
                                                    );
                                                  } else {
                                                    {
                                                      safeSetState(() => _model
                                                              .isDataUploading_uploadDataCgk =
                                                          true);
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_uploadDataCgk =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_uploadDataCgk =
                                                              selectedUploadedFiles
                                                                  .first;
                                                          _model.uploadedFileUrl_uploadDataCgk =
                                                              downloadUrls
                                                                  .first;
                                                        });
                                                      } else {
                                                ...
                                                onPressed: () async {
                                                  {
                                                    ...
                                                    try {
                                                      ...
                                                      _model.isDataUploading_uploadDataZis =
                                                          false;
                                                    }
                                                    if (selectedUploadedFiles
                                                                .length ==
                                                        ...
                                                        downloadUrls.length ==
                                                            selectedMedia
                                                                .length) {
                                                      safeSetState(() {
                                                        _model.uploadedLocalFile_uploadDataZis =
                                                            selectedUploadedFiles
                                                                .first;
                                                        _model.uploadedFileUrl_uploadDataZis =
                                                            downloadUrls.first;
                                                      });
                                                    } else {
                                                      safeSetState(() {});
