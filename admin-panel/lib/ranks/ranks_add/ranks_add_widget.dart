...
class RanksAddWidget extends StatefulWidget {
  const RanksAddWidget({
    super.key,
    this.ranksRow,
  });

  final RanksRow? ranksRow;

  static String routeName = 'RanksAdd';
  static String routePath = 'ranksAdd';

  @override
  State<RanksAddWidget> createState() => _RanksAddWidgetState();
}

class _RanksAddWidgetState extends State<RanksAddWidget> {
  late RanksAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RanksAddModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.ranksRow != null) {
        safeSetState(() {
          _model.nameInputTextController?.text = widget.ranksRow!.title!;
        });
        safeSetState(() {
