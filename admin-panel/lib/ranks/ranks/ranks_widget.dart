...
import 'ranks_model.dart';
export 'ranks_model.dart';

class RanksWidget extends StatefulWidget {
  const RanksWidget({super.key});

  static String routeName = 'Ranks';
  static String routePath = 'ranks';

  @override
  State<RanksWidget> createState() => _RanksWidgetState();
}

class _RanksWidgetState extends State<RanksWidget> {
  late RanksModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RanksModel());
