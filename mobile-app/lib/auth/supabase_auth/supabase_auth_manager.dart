...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future updateEmail({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(
              'Отправлено письмо с подтверждением изменения электронной почты!')),
    );
  }
  ...
  Future resetPassword({
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Письмо со сбросом пароля отправлено!')),
    );
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : AlabugaAppSupabaseUser(user);
