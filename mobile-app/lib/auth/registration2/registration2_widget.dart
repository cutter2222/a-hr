...
import 'registration2_model.dart';
export 'registration2_model.dart';

class Registration2Widget extends StatefulWidget {
  const Registration2Widget({super.key});

  static String routeName = 'Registration2';
  static String routePath = '/registration2';

  @override
  State<Registration2Widget> createState() => _Registration2WidgetState();
}

class _Registration2WidgetState extends State<Registration2Widget> {
  late Registration2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Registration2Model());
                      ...
                      child: Column(
                        ...
                        children: [
                          wrapWithModel(
                            ...
                            child: MessageWidget(
                              title: 'Привет, я робот кавик!',
                              text:
                                  'Добро пожаловать в особую экономическую зону Алабуга. Давай знакомиться.',
                              rightSide: false,
                            ),
                          ),
                          ClipRRect(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: valueOrDefault<Color>(
                                    (_model.firstNameInputFocusNode?.hasFocus ??
                                            false)
                                  ...
                                  children: List.generate(childGender.length,
                                    ...
                                    return InkWell(
                                      ...
                                      child: ChoiceChipsWidget(
                                        key: Key(
                                            'Keymme_${childGenderIndex}_of_${childGender.length}'),
                                        text: functions
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      if ((_model.firstNameInputTextController.text != null &&
                        ...
                        context.pushNamed(Registration3Widget.routeName);
                      } else {
