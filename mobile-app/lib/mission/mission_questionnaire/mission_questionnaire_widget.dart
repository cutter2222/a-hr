...
import 'mission_questionnaire_model.dart';
export 'mission_questionnaire_model.dart';

class MissionQuestionnaireWidget extends StatefulWidget {
  const MissionQuestionnaireWidget({
    super.key,
  ...
  static String routeName = 'MissionQuestionnaire';
  static String routePath = '/missionQuestionnaire';

  @override
  State<MissionQuestionnaireWidget> createState() =>
      _MissionQuestionnaireWidgetState();
}

class _MissionQuestionnaireWidgetState
    extends State<MissionQuestionnaireWidget> {
  late MissionQuestionnaireModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MissionQuestionnaireModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget!.viewMissionsRow?.content != null) {
        _model.missionQuestionnaire = MissionQuestionnaireStruct.maybeFromMap(
                                  ...
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              '${(_model.index + 1).toString()} / ${_model.missionQuestionnaire?.missionQuestionnaireData?.length?.toString()}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.montserrat(
                              ...
                              Padding(
                                ...
                                child: wrapWithModel(
                                  ...
                                  child: ProgressBarWidget(
                                    ...
                                    plan: _model.missionQuestionnaire
                                        ?.missionQuestionnaireData?.length
                                        ?.toDouble(),
                                    padding: 16,
                                  ),
                                ),
                                  ...
                                  children: List.generate(childAnswers.length,
                                    ...
                                    return InkWell(
                                      ...
                                      child: BorderedQuizContainerWidget(
                                        key: Key(
                                            'Key431_${childAnswersIndex}_of_${childAnswers.length}'),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          if (_model.index !=
                              functions.subtractOne(_model.missionQuestionnaire
                                  ?.missionQuestionnaireData?.length)) {
                            return InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
