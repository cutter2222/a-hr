...
import 'dart:ui';
import 'mission_take_photo_video_widget.dart' show MissionTakePhotoVideoWidget;
...
class MissionTakePhotoVideoModel
    extends FlutterFlowModel<MissionTakePhotoVideoWidget> {
  ...
  bool isDataUploading_uploadData732p = false;
  FFUploadedFile uploadedLocalFile_uploadData732p =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData732p = '';

  bool isDataUploading_uploadData555n = false;
  FFUploadedFile uploadedLocalFile_uploadData555n =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData555n = '';
