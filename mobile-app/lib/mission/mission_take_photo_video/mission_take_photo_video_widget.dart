...
import 'mission_take_photo_video_model.dart';
export 'mission_take_photo_video_model.dart';

class MissionTakePhotoVideoWidget extends StatefulWidget {
  const MissionTakePhotoVideoWidget({
    super.key,
  ...
  static String routeName = 'MissionTakePhotoVideo';
  static String routePath = '/missionTakePhotoVideo';

  @override
  State<MissionTakePhotoVideoWidget> createState() =>
      _MissionTakePhotoVideoWidgetState();
}

class _MissionTakePhotoVideoWidgetState
    extends State<MissionTakePhotoVideoWidget> {
  late MissionTakePhotoVideoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MissionTakePhotoVideoModel());
  }
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (context, photoUrlsIndex) {
                                    ...
                                    return UploadPhotoItemWidget(
                                      key: Key(
                                          'Keyvf4_${photoUrlsIndex}_of_${photoUrls.length}'),
                                      photo: photoUrlsItem,
                                      onDelete: () async {
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData732p = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadData732p =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData732p =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadData732p =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                                ...
                                if (_model.uploadedFileUrl_uploadData732p !=
                                        null &&
                                    _model.uploadedFileUrl_uploadData732p !=
                                        '') {
                                  _model.updateMissionProofsStruct(
                                    (e) => e
                                      ..updatePhotoUrls(
                                        (e) => e.add(_model
                                            .uploadedFileUrl_uploadData732p),
                                      ),
                                  );
                                  safeSetState(() {});
                                } else {
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (context, videoUrlsIndex) {
                                    ...
                                    return UploadVideoItemWidget(
                                      key: Key(
                                          'Keyt6x_${videoUrlsIndex}_of_${videoUrls.length}'),
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                    selectedMedia.every((m) =>
                                        validateFileFormat(
                                            m.storagePath, context))) {
                                  safeSetState(() => _model
                                      .isDataUploading_uploadData555n = true);
                                  var selectedUploadedFiles =
                                      <FFUploadedFile>[];
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_uploadData555n =
                                        false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                          selectedMedia.length &&
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_uploadData555n =
                                          selectedUploadedFiles.first;
                                      _model.uploadedFileUrl_uploadData555n =
                                          downloadUrls.first;
                                    });
                                  } else {
                                    safeSetState(() {});
                                ...
                                if (_model.uploadedFileUrl_uploadData555n !=
                                        null &&
                                    _model.uploadedFileUrl_uploadData555n !=
                                        '') {
                                  _model.updateMissionProofsStruct(
                                    (e) => e
                                      ..updateVideoUrls(
                                        (e) => e.add(_model
                                            .uploadedFileUrl_uploadData555n),
                                      ),
                                  );
                                  safeSetState(() {});
                                } else {
