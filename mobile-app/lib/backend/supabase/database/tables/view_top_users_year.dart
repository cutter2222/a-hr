...
class ViewTopUsersYearTable extends SupabaseTable<ViewTopUsersYearRow> {
  @override
  String get tableName => 'view_top_users_year';

  @override
  ViewTopUsersYearRow createRow(Map<String, dynamic> data) =>
      ViewTopUsersYearRow(data);
}

class ViewTopUsersYearRow extends SupabaseDataRow {
  ViewTopUsersYearRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewTopUsersYearTable();
